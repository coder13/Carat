...
const generate = module.exports.generate = (ast => require('escodegen').generate(ast, genOptions));
...
const matches = module.exports.matches = function (node, object, identifier) {
	if (node === object) {
		return true;
	} if (node.type === 'Identifier' && node.value && !identifier) {
...
const isName = module.exports.isName = function (i) {
	return i === 'Identifier' || i === 'MemberExpression';
};

const stringifyArg = module.exports.stringifyArg = function (arg) {
	if (arg) {
